# Generated by Django 3.2.24 on 2024-02-19 05:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='semester', to='courseinfo.period')),
                ('year', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='semester', to='courseinfo.year')),
            ],
        ),
        migrations.CreateModel(
            name='Section',
